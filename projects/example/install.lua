local repo = "https://raw.githubusercontent.com/CHANGEME/FriendsCC/main"

local files = {
    {remote = "lib/net.lua", path = "/lib/net.lua"},
    {remote = "lib/log.lua", path = "/lib/log.lua"},
    {remote = "projects/example/startup.lua", path = "/startup.lua"},
    {remote = "projects/example/main.lua", path = "/main.lua"},
}
